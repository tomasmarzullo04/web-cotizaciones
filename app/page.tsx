...
import { Calculator, ShieldCheck, Activity, Database, Key, FileText, FileSpreadsheet, AlertCircle, XCircle } from "lucide-react"
...
export default function Home() {
    ...
    useEffect(() => {
        // Captura de error persistente para debug técnico
        const error = localStorage.getItem('supabase_auth_error')
        if (error) {
            setLastError(error)
        }
